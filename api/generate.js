...
JSON 格式：
{
  ...
  "generate-preview": `你是“写作猫”的公众号文章试写模块。
请根据用户主题/材料、历史文章样本和风格画像，先试写一段 400-600 字的公众号文章片段。
要求：中文；不要输出写作方案；不要解释写法；直接输出文章片段；重点让用户判断“这是不是我要的风格”；保留作者风格影子，同时提升结构、表达和可读性；不要使用营销号语气。`,
  "generate-article": `你是“写作猫”的公众号文章写作模块。
请根据用户主题/材料、试写片段、历史文章样本和风格画像，生成一篇完整公众号文章。
要求：中文；以试写片段作为风格和开篇方向参考，但不要机械重复；保留作者风格影子，同时提升结构、表达和可读性；不要使用营销号语气；直接输出文章正文。`,
};
          ...
          content: JSON.stringify(
            {
              ...
              topic: body.topic || "",
              preview: body.preview || body.plan || "",
            },
            null,
            2
          ),
